...
module.exports = ".contain {\n  width: 90%;\n  margin: 0 auto; }\n\n.table {\n  width: 50%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var SelectPayPeriodComponent = /** @class */ (function () {
    function SelectPayPeriodComponent() {
        ...
        setInterval(function () {
            ...
            _this.datemessage = currentDate.toDateString();
        });
        setInterval(function () {
            var currentTime = new Date();
            _this.timemessage = currentTime.toLocaleTimeString();
        }, 1000);
    }
    SelectPayPeriodComponent_1 = SelectPayPeriodComponent;
    SelectPayPeriodComponent.controller = function (arg0, arg1) {
        throw new Error('Method not implemented.');
    };
    SelectPayPeriodComponent.prototype.ngOnInit = function () {
        SelectPayPeriodComponent_1.controller('edit', function edit($scope, usersApi, clockApi, payperiodFactory, totaltimeFactory) {
            $scope.currentTimes = {};
            $scope.currentUser = 0;
            $scope.selectedDate = moment__WEBPACK_IMPORTED_MODULE_2__();
            $scope.startDate = '';
            $scope.endDate = '';
            $scope.startTime = '';
            $scope.endTime = '';
            ...
            $scope.addRow = function () {
                var start = moment__WEBPACK_IMPORTED_MODULE_2__($scope.selectedDate + ' ' + $scope.startTime, 'YYYY-MM-DD h:mm a').format('YYYY-MM-DD HH:mm:ss');
                var end = moment__WEBPACK_IMPORTED_MODULE_2__($scope.selectedDate + ' ' + $scope.endTime, 'YYYY-MM-DD h:mm a').format('YYYY-MM-DD HH:mm:ss');
    ...
    var SelectPayPeriodComponent_1;
    SelectPayPeriodComponent = SelectPayPeriodComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
